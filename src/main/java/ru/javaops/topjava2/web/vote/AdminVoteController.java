...
public class AdminVoteController {
    ...
    @GetMapping
    @Cacheable
    public List<Vote> getAllByDate(@AuthenticationPrincipal AuthUser authUser, @RequestParam LocalDate date) {
    ...
    public List<VoteTo> getRatingByDate(@AuthenticationPrincipal AuthUser authUser, @RequestParam LocalDate date) {
